...
class __TwigTemplate_9ec35f829942c54e6b83a6eac0dee2f5c04ae84e9664e64ecc06f7f7e9809cf3 extends Twig_Template
{
...
";
    ...
    // line 1
    public function getrenderBlocksItem($__item__ = null, $__context__ = null)
    {
...
/*       <div class="block-header"><img src="{{ item.image }}" {% if item.image2x %} srcset="{{ item.image }} 1x, {{ item.image2x }} 2x" {% endif %} alt="{{ item.alt }}" class="block-image" width="{{ context.imageDimensions.width }}" height="{{ context.imageDimensions.height }}"/></div>*/
